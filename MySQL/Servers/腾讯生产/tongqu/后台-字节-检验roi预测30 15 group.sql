 SELECT 
date, app_id, ad_consume, roi1, roi2, roi3, roi4, roi5, roi6, roi7, roi15,
0.0518 + 0.0503*roi1 - 0.7442*roi2 + 0.1722*roi3 + 0.0857*roi4 - 0.4341*roi5 - 0.0133*roi6 + 0.6258*roi7 + 1.1644*roi15 roi_pred30_by7,
0.0518 + 0.0503*roi1 - 0.7442*roi2 + 0.1722*roi3 + 0.0857*roi4 - 0.4341*roi5 - 0.0133*roi6 + 0.6258*roi7 + 1.1644*roi15 - roi15 increase15
